...
namespace Exemple.Domain
{
    ...
    {
        public static ICartProducts ValidatedCartProducts(Func<StudentRegistrationNumber, bool> checkClientExists, UnvalidatedExamGrades examGrades)
        {
            List<ValidatedCart> validatedGrades = new();
